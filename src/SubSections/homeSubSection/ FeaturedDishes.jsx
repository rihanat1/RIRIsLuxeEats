...
const FeaturedDishes = () => {
  ...
  return (
    <div className=' pt-12 xl:pt-14 px-4 pb-24 xl:pb-16'>
      <div className="md:w-[95%] xl:w-[80%] mx-auto">
        <div className="flex flex-col gap-2 mb-8">
        <h3 className="text-primary text-3xl lg:text-4xl md:text-[38px] font-normal x">Featured Dishes</h3>
        <div className="flex items-center justify-between">
            <p className="text-secondary sm:text-[18px] text-sm md:text-md lg:text-lg">Curated selections from our top partner restaurants.</p>
